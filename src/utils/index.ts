 ...
 */
export const logger = (id: PeerId, subsystem?: string) => {
  const name = ['bitswap']
  if (subsystem) {
    name.push(subsystem)
  }
 ...
 */
export const isMapEqual = (a: Map<string, Uint8Array | BitswapMessageEntry>, b: Map<string, Uint8Array | BitswapMessageEntry>) => {
  if (a.size !== b.size) {
    return false
  }
